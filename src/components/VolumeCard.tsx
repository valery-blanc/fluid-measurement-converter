...
const VolumeCard = () => {
  ...
  const updateFromValue1 = (val: number) => {
    setValue2(convertVolume(val, unit1, unit2).toFixed(5));
    setValue3(convertVolume(val, unit1, unit3).toFixed(5));
    setValue4(convertVolume(val, unit1, unit4).toFixed(5));
  };

  const updateFromValue2 = (val: number) => {
    setValue1(convertVolume(val, unit2, unit1).toFixed(5));
    setValue3(convertVolume(val, unit2, unit3).toFixed(5));
    setValue4(convertVolume(val, unit2, unit4).toFixed(5));
  };

  const updateFromValue3 = (val: number) => {
    setValue1(convertVolume(val, unit3, unit1).toFixed(5));
    setValue2(convertVolume(val, unit3, unit2).toFixed(5));
    setValue4(convertVolume(val, unit3, unit4).toFixed(5));
  };

  const updateFromValue4 = (val: number) => {
    setValue1(convertVolume(val, unit4, unit1).toFixed(5));
    setValue2(convertVolume(val, unit4, unit2).toFixed(5));
    setValue3(convertVolume(val, unit4, unit3).toFixed(5));
  };
